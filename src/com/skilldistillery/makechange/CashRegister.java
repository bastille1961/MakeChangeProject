...
public class CashRegister {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			double totalSale = (applesQty * applesPrc) +
								(deangeloPearsQty * deangeloPearsPrc) +
								(sunKistOrangQty * sunKistOrangPrc) +
								(potChipsPlainQty * potChipsPlainPrc) +
								(potChipsBbqQty * potChipsBbqPrc) +
								(breadLoafQty * breadLoafPrc) +
								(eggsDozQty * eggsDozPrc) +
								(butterQty * butterPrc) +
								(milkWholeQty * milkWholePrc) +
								(vegOilCanolaQty * vegOilCanolaPrc) +
								(vegOilOliveQty * vegOilOlivePrc) +
								(spamCanQty * spamCanPrc);
			...
			System.out.println("Please enter the amount of cash entered into the automated checkout receptacle in the space provided.");
			double cashTendered = keyboard.nextDouble();
			
			double change = cashTendered - totalSale;
			
			if (cashTendered < totalSale) {
				System.out.println("The amount you are tendering is less than the value of the items you want to purchase.");
			} else {
			...
			System.out.println("Review the change provided. You should have been provided with the following denominations:");
			...
			System.out.println("One Dollar Bills: " + quarters);
			System.out.println("One Dollar Bills: " + dimes);
			System.out.println("One Dollar Bills: " + nickels);
			System.out.println("One Dollar Bills: " + pennies);
			
			System.out.println("Thank you for shopping at Distillery's Cash and Carry where great prices and freshness are guaranteed!");
